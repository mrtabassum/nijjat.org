...
<div class="page-container">
                ...
                <div class="col-md-6 col-sm-4 clearfix">
                    <ul class="notification-area pull-right">
                        ...
                        @php 
                            ...
                            $total_notification_count = is_array($all_notifiacations) ? 0 : $all_notifiacations->where('seen',0)->count();
                
                        @endphp
                            <li class="dropdown">
                                <i class="ti-bell dropdown-toggle" data-toggle="dropdown">
                          
                                    <span>{{$total_notification_count}}</span>
                                </i>
                                <div class="dropdown-menu bell-notify-box notify-box">
                                    @if($total_notification_count > 0)
                                        <span class="notify-title">{{sprintf('You have %s new notifications',$total_notification_count)}}
    ...
    <footer>
        <div class="footer-area footer-wrap">
            ...
            <p class="version">v-{{get_static_option('site_script_version','1.3.0')}}</p>
        </div>
    </footer>
</div>
