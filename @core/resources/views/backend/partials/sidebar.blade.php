                ...
                'event-settings'
                    ...
                    <li class="main_dropdown @if(request()->is('admin-home/form-builder/*')) active @endif">
                        ...
                        <ul class="collapse">
                            ...
                            <li class="{{active_menu('admin-home/tax-certificates/settings')}}"><a
                    ...
                    <li class="main_dropdown @if(request()->is(['admin-home/reward/all','admin-home/reward/settings'])) active @endif">
                        <a href="javascript:void(0)"
                           aria-expanded="true">
